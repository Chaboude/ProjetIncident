...
namespace ProjetIncident.Core
{
    public class NavigationService
    {
        ...
        private NavigationService()
        {
            ...
            _menuPage = new View.MainMenuPage();
            _menuPage.BindingContext = new ViewModel.MainMenuViewModel();
            RootPage.Master = _menuPage;

            _navigationPage = new NavigationPage(new View.HomePage());
            _navigationPage.BindingContext = new ViewModel.HomeViewModel();
