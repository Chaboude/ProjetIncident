        ...
        public MainMenuViewModel()
        {
            switch (Device.RuntimePlatform)
            {
                case Device.iOS:
                    ...
                    break;
                default:
                    MenuTitle = "Projet Incident";
                    break;
            }

            Menus = new ObservableCollection<MenuItem>();
            Menus.Add(new MenuItem("home.png", "Accueil", typeof(View.HomePage), typeof(HomeViewModel)));
            Menus.Add(new MenuItem("settings.png", "Paramètres", typeof(View.SettingsPage), typeof(SettingsViewModel)));
        }
    }
}
